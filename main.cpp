/*
-----------------------------------------------------------------------------
See the README for instructions on how to run the project with Visual Studio.
-----------------------------------------------------------------------------
...
const char* filename;
//const char* material_filename = "teapot.mtl";
//const char* brick_png_path = "brick.png";
//const char* brick_specular_png_path = "brick-specular.png";
...
void _bind_material(rc::rcTriMeshForGL& mesh, Texture& texture, const int texture_id, const char* sampler_name)
{
	cyGLTexture2D tex;
	tex.Initialize();
...
void _bind_texture(rc::rcTriMeshForGL& mesh)
{
	...
	Texture texture(mtl.map_Ka.data);
	_bind_material(mesh, texture, 0, "tex");

	Texture diffuse_texture(mtl.map_Kd.data);
	_bind_material(mesh, diffuse_texture, 1, "diffuse_map");
	
	Texture specular_texture(mtl.map_Ks.data);
